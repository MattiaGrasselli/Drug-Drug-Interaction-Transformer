...
from model.DDItransformer import TransformerDDI_FCL
import argparse
from torch.utils.data import DataLoader
from sklearn.metrics import recall_score, precision_score,f1_score,accuracy_score
import os

parser=argparse.ArgumentParser(description="Drug-Drug Interaction test for TransformerDDI with Fully-connected fusion and classification.")
...
parser.add_argument("--num-hidden", type=int, dest="hidden", default=2, help="Number of hidden layers utilized in the feature fusion and classification fully-connected layers")
...
model=TransformerDDI_FCL(left_config,right_config,num_hidden_linear_layers=num_hidden)
model.to(device)
